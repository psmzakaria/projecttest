...
project  setup:
- create npm project and make it a git repo
- create simple express app (return ‘hello world’ for `GET /`)
- write a test (`expect(response.body).toEqual('hello world')`)
- create a test script for running test (i) once and (ii) in watch mode
- Add CircleCI config to your project:
...
(go to github.com and create a empty repo)
